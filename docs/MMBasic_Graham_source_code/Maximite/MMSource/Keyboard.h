...
#define KB_BIT_TIMEOUT      5           // flag an error all 10 bits from they keyboard has not been received in this number of mSec
#define KB_STATE_TIMEOUT    10000       // flag an error if the keyboard has not been used for this many mSec and any state key is down

// PS2 KBD state machine and buffer
extern volatile int PS2State;
